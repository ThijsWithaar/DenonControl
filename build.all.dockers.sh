...
docker run --user $(id -u):$(id -g) -v ${TRAVIS_BUILD_DIR}:${DOCKER_BUILD_DIR} -w ${DOCKER_BUILD_DIR} thijswithaar/raspbian:buster ${DOCKER_BUILD_DIR}/build.sh build.raspbian
